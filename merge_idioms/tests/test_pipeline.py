...
class TestMergeIdiomsPipeline(TestCase):
    ...
    def test_have_ones_blood_on_ones_hands(self):
    ...
    def test_end_of_the_world(self):
    ...
    def test_not_the_end_of_the_world(self):
